...
namespace CyberLife.Simple2DWorld
{
    public class BotLifeForm : LifeForm
    {
        ...
        public BotLifeForm(Point point) : base(point)
        {
            Dead = false;
        ...
        public BotLifeForm(Point point, BotLifeForm byBot) : base(point)
        {
            Dead = false;
            LastEnergyActions = new Queue<Actions> { };
        ...
        public BotLifeForm(MapSize mapsize,Dictionary<Point,LifeForm> bots) : this(Point.RandomPoint(mapsize,bots))
        {
